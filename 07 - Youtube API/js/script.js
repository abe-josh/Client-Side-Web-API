// Get reference to DOM elements we need to manipulate
...
function onYoutubeApiLoad() {
    ...
    // 7. Select "Web browser (JavaScript)" from the seconf dropdown
    ...
    gapi.client.setApiKey('AIzaSyCUlPY4Qn6Vh6Mficm47a9FiVIMOeHnvEk');
...
function onSearchResponse(response){
    // looping through each element inside the <section> element, we need to clear the items inside the <section> element before displaying/adding new items
